...
class ProjectApprovalController {
  ...
  static async getById(req, res) {
    try {
      ...
      console.log('🔍 Buscando proyecto con temporal_id:', temporalId);
  ...
  static async approve(req, res) {
    try {
      ...
      console.log('🔍 Aprobando proyecto con temporal_id:', temporalId);
  ...
  static async reject(req, res) {
    try {
      ...
      console.log('🔍 Rechazando proyecto con temporal_id:', temporalId);
      console.log('👤 Revisado por:', reviewedBy);
